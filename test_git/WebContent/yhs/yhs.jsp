...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css"href="http://211.238.142.28/jsp_prj/common/css/main.css">
...
#headerTop{width: 900px;height: 140px;position: relative;
			background: #FFFFFF url("http://211.238.142.28/jsp_prj/common/images/header_bg.png")}
...
<div id="wrap">
	<div id="header">
		...
		<div id="naviBar">
			<c:import url="../common/jsp/menu.jsp"></c:import>
